...
import CategoriesTable from '@/components/main/dashboard/CategoriesTable';
import NewCategoryUpdateForm from '@/components/main/dashboard/NewCategoryUpdateForm';
      ...
      <Suspense
        fallback={
          <EmptyTableBody
            cols={10}
            rows={12}
            tableHeaders={categoryTableHeads}
          />
        }
      >
        <CategoriesTable />
