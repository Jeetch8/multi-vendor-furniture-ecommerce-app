    ...
    <footer className="border-t border-border bg-background py-8 mt-auto">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="mb-6 w-full md:mb-0 md:w-1/4">
            <h6 className="mb-4 text-foreground font-medium">Quick Links</h6>
          ...
          <div className="mb-6 w-full md:mb-0 md:w-1/4">
            <h6 className="mb-4 text-foreground font-medium">
              Customer Service
            </h6>
            <ul className="flex flex-col gap-2 text-sm">
              <li className="mb-1">
          ...
          <div className="w-full md:w-1/4">
            <h6 className="mb-4 text-foreground font-medium">Stay Connected</h6>
