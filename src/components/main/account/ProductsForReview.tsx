...
import { calculateTotalProductRating, formatDate } from '@/utils/helpers';
            ...
            <div className="flex h-full w-[85%] flex-col gap-3">
              ...
              >
                ...
                <div className="flex items-center gap-x-1">
                  <p className="text-xs">
                    {i.product.reviews.map((r) => r.rating)}
                  </p>
                  <Rating
                    editable={false}
                    size={5}
                ...
                <p className="text-xs">
                  ...
                  {formatDate(i?.updatedAt as Date)}
                </p>
              </Link>
              <div className="mt-2">
                <Dialog>
