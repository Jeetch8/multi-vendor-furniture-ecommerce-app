...
const Card = ({
  ...
  <div className={`mb-4 rounded-md border bg-white p-5 ${className}`}>
    {children}
  </div>
);
...
const AccountSettingsForm = ({ user }: { user: TUserForAccountSetings }) => {
        ...
        {isEditing?.email ? (
          <div className="flex items-center gap-2">
            ...
            {formState.errors?.email && (
              <FormError>{formState.errors?.email}</FormError>
            )}
          </div>
        ) : (
        ...
        {isEditing?.name ? (
          <div className="flex items-center gap-2">
            ...
            {formState.errors?.name && (
              <FormError>{formState.errors?.name}</FormError>
            )}
          </div>
        ) : (
          <div className="flex items-center justify-between">
