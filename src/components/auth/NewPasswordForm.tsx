...
function NewPasswordForm() {
  const [formState, action] = useFormState(newPasswordAction, { errors: {} });
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-gray-500">
              A valid token is required for password reset. Please use the link
              from your password reset email or create a new password reset
              request.
            </p>
          </div>
        </div>
  ...
  return (
    <Form action={action}>
      ...
      <SubmitButton className="bg-foreground text-white">Reset</SubmitButton>
    </Form>
  );
}
